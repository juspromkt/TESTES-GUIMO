  ...
  const quickActions = [
    {
      ...
      description: 'Tire dúvidas rápidas e receba ajuda instantânea da nossa equipe',
      icon: MessageCircle,
    ...
    },
    {
      ...
      description: 'Suporte exclusivo e personalizado para questões complexas que exigem atenção especial',
      icon: Calendar,
    ...
    },
    {
      ...
      description: 'Aprenda a usar todas as funcionalidades da plataforma com vídeos passo a passo',
      icon: Video,
    ...
    },
    {
      ...
      description: 'Tutoriais práticos e conteúdos estratégicos para você dominar a plataforma',
      icon: BookOpen,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 transition-theme">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {quickActions.map((action) => (
              <div
                ...
                className="group relative bg-white dark:bg-neutral-800 rounded-xl p-6 cursor-pointer overflow-hidden border border-gray-200 dark:border-neutral-700 hover:border-transparent transition-all duration-300 hover:shadow-xl hover:scale-[1.02] min-h-[180px] flex flex-col"
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  {/* Icon */}
                  <div className={`${action.iconBg} w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:bg-white/20 transition-colors`}>
                    <action.icon className={`w-7 h-7 ${action.iconColor} group-hover:text-white transition-colors`} />
                  </div>
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <p className="text-sm text-gray-600 dark:text-neutral-400 group-hover:text-white/90 transition-colors leading-relaxed">
                      {action.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-pink-600 to-orange-600 rounded-xl p-6 text-center flex flex-col min-h-[180px]">
            {/* Background Pattern */}
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div>
                ...
                <p className="text-sm text-white/90 leading-relaxed mb-4">
                  Receba em primeira mão todas as atualizações, novidades e dicas exclusivas da plataforma
                </p>
              </div>

              <button
                onClick={() => window.open('https://chat.whatsapp.com/FqKrpy3oO4hGwKdiAflnJ8', '_blank')}
                className="inline-flex items-center justify-center gap-2 w-full px-6 py-3 bg-white text-purple-600 font-bold rounded-lg hover:bg-gray-100 transition-all hover:scale-105 shadow-xl"
              >
