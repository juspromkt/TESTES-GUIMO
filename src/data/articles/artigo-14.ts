      ...
      <div class="space-y-6">
        <section>
          ...
          <p class="mb-3">
            ...
            <strong>mova automaticamente os leads entre os estágios do funil do CRM</strong>, conforme o atendimento avança.
          </p>
          <p class="mb-3">
            Você pode configurar uma <strong>vinculação direta entre cada estágio do Agente de IA</strong> (exemplo: "Apresentando solução", "Negociação", "Fechamento")
        ...
        <section>
          ...
          <div class="bg-gray-50 dark:bg-neutral-800/50 p-4 rounded-lg mb-4">
            <h3 class="font-bold text-gray-900 dark:text-white mb-2">📋 Etapa 1 – Vincule cada estágio da IA a um estágio do CRM</h3>
            <ul class="list-disc list-inside space-y-2 ml-4">
              <li>Na seção <strong>Movimentação Automática</strong>, você verá todos os estágios configurados na sua <strong>IA</strong> (etapas do fluxo de conversa).</li>
              <li>Ao lado de cada estágio da IA, existe um menu suspenso (dropdown) que lista <strong>todos os estágios do seu CRM</strong>.</li>
              <li>📌 Selecione em qual etapa do CRM você quer que o lead seja movido quando o Agente de IA avançar para aquele estágio.</li>
            </ul>
          </div>
          ...
          <div class="bg-gray-50 dark:bg-neutral-800/50 p-4 rounded-lg mb-4">
            ...
            <p class="mb-2">
              Isso é feito uma única vez. Após vincular, todos os estágios do CRM ficam disponíveis para mapeamento.
            </p>
          </div>
          ...
          <div class="bg-gray-50 dark:bg-neutral-800/50 p-4 rounded-lg mb-4">
            ...
            <p class="mb-2">
              ...
              <strong>cada vez que a IA avançar um lead para um novo estágio, ele será movido automaticamente no CRM correspondente</strong>.
            </p>
          </div>
        </section>
          ...
          <table class="w-full border-collapse border border-gray-300 dark:border-neutral-700 mb-4">
            <thead>
              <tr class="bg-gray-100 dark:bg-neutral-800">
                <th class="border border-gray-300 dark:border-neutral-700 px-4 py-2 text-left">Estágio da IA</th>
                <th class="border border-gray-300 dark:border-neutral-700 px-4 py-2 text-left">Estágio do CRM</th>
              </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <section>
          ...
          <ol class="list-decimal list-inside space-y-2 ml-4">
            ...
            <li>A IA move automaticamente o card desse lead no CRM para o estágio <strong>vinculado</strong> (ex: "Negociação").</li>
          ...
          <p class="mt-3">
            ✅ Isso <strong>elimina a necessidade de mover leads manualmente</strong> e garante que o CRM esteja sempre atualizado, refletindo o real estágio de cada negociação.
          </p>
        </section>
        ...
        <section>
          ...
          <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-4 rounded-lg">
            <h3 class="font-bold text-green-900 dark:text-green-300 mb-2">♻️ Atualizar lista de estágios do CRM</h3>
            <p class="text-green-800 dark:text-green-200">
              Se você criou novos estágios no CRM recentemente, clique em <strong>"Atualizar"</strong> para carregar as novas opções na lista.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <ul class="list-disc list-inside space-y-2 ml-4">
            <li>✅ Certifique-se de que os nomes dos estágios da IA e do CRM estão <strong>claros e organizados</strong>, para facilitar o mapeamento.</li>
        ...
        <section>
          ...
          <blockquote class="border-l-4 border-purple-500 bg-purple-50 dark:bg-purple-900/20 p-4 italic">
            ...
            sua equipe de vendas sempre saberá <strong>exatamente em qual estágio cada lead está</strong>, sem precisar atualizar manualmente.
          ...
          <table class="w-full border-collapse border border-gray-300 dark:border-neutral-700">
            ...
            <tbody>
              ...
              <tr class="bg-gray-50 dark:bg-neutral-800/50">
                ...
                <td class="border border-gray-300 dark:border-neutral-700 px-4 py-2">Mover leads automaticamente no CRM conforme estágio da IA</td>
              </tr>
              <tr>
