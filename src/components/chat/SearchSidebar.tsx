...
export default function SearchSidebar({
  ...
  return (
    <div className={`
      ...
      bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 shadow-lg
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 rounded-lg focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent outline-none"
            autoFocus
          />
        </div>
      </div>
