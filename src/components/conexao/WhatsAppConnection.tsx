    ...
    <div>
      {connection ? (
        <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-md overflow-hidden">
          ...
          {/* Connection Actions */}
          {canEditConnection && (
            <div className="p-6 bg-gray-50 dark:bg-neutral-700/50 flex flex-col gap-3">
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-700 text-gray-900 dark:text-neutral-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
