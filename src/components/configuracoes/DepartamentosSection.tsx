                ...
                departamentos.map((departamento) => (
                  <tr key={departamento.Id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500">#{departamento.Id}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <Building2 className="w-4 h-4 text-indigo-600" />
                        <div className="text-sm font-medium text-gray-900">{departamento.nome}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900">{departamento.descricao}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="departamentoAtivo" className="text-sm text-gray-700">
                  Departamento ativo
                </label>
              </div>
              {formError && (
            ...
            <form onSubmit={handleEdit} className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                />
                <label htmlFor="editDepartamentoAtivo" className="text-sm text-gray-700">
                  Departamento ativo
                </label>
              </div>
              {editError && (
