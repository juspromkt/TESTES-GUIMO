  ...
  return createPortal(
    <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center p-2 sm:p-8 z-[10001] animate-fadeIn">
      ...
      >
        ...
        {/* Content - Layout Horizontal em desktop, Vertical em mobile */}
          ...
          <div className="flex-1 p-6 sm:p-10 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  className="group bg-white dark:bg-neutral-800 backdrop-blur-sm rounded-xl p-3 sm:p-4 border border-gray-300 dark:border-neutral-600 hover:border-orange-400 dark:hover:border-orange-500 transition-all hover:shadow-lg"
                >
                  <div className="flex items-start gap-2.5 sm:gap-3">
                    <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br ${benefit.color} flex items-center justify-center flex-shrink-0 shadow-md`}>
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-neutral-400 flex items-center gap-2">
              <MessageCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-orange-600 dark:text-orange-400" />
              Resposta imediata pelo WhatsApp — nossa equipe está pronta pra te ajudar!
            </p>
          </div>

          {/* Coluna Direita - Features e CTA */}
          <div className="w-full sm:w-[440px] bg-gradient-to-br from-orange-50/80 to-purple-50/80 dark:from-neutral-800/80 dark:to-neutral-800/80 backdrop-blur-sm border-t sm:border-t-0 sm:border-l border-gray-200 dark:border-neutral-700 p-6 sm:p-10 flex flex-col justify-center">
            {/* Additional Features */}
            <div className="mb-6 sm:mb-8">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full px-6 py-3.5 sm:py-4 bg-gradient-to-r from-orange-600 to-purple-600 hover:from-orange-700 hover:to-purple-700 text-white font-bold text-sm sm:text-base rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group"
              >
              ...
              <button
                onClick={onClose}
                className="w-full px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-gray-600 dark:text-neutral-300 hover:text-gray-800 dark:hover:text-neutral-100 transition-colors font-medium"
              >
