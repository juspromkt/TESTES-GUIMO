...
export default function ScheduleWindowsSection({ token, canEdit }: ScheduleWindowsSectionProps) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Horários Disponíveis</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">Funciona na agenda interna e Google Agenda</p>
      </div>

      <div className="space-y-4">
        {days.map((day) => (
          <div key={day} className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-sm text-gray-900 dark:text-gray-100">{dayLabels[day]}</span>
            ...
            <div className="space-y-2">
              ...
              {windows[day].length === 0 && (!editing || editing.day !== day) && (
                <p className="text-xs text-gray-500 dark:text-gray-400 text-center py-2">Nenhum horário cadastrado</p>
              )}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                  Tem certeza que deseja excluir este horário de <span className="font-semibold text-gray-900 dark:text-gray-100">{deleteConfirm.day}</span>? Esta ação não pode ser desfeita.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
                  Os horários de <span className="font-semibold text-gray-900 dark:text-gray-100">{dayLabels[replicateConfirm]}</span> serão replicados para todos os outros dias da semana.
                </p>
