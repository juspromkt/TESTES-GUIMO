...
export default function AIPromptGenerator({ token, onApplyModel, canEdit, idAgente }: AIPromptGeneratorProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('https://n8n.lumendigital.com.br/webhook/prospecta/multiagente/prompt/gerar', {
        method: 'POST',
        headers: {
    ...
    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl shadow-md p-8 mb-8 border border-indigo-100">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-indigo-50 border border-indigo-200 text-indigo-700 px-4 py-3 rounded-lg">
          ...
          <p className="mt-1 text-sm">Gerar um prompt com IA consome <strong>30 créditos</strong> do seu Agente.</p>
        </div>
          ...
          {generatedModel && (
            <>
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Ãrea de Expertise</h3>
                  <div className="bg-gray-50 p-4 rounded-lg">
