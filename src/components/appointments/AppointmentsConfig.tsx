    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">Configure lembretes automáticos para seus agendamentos</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-xl overflow-hidden">
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          {/* Status Toggle */}
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl border border-blue-100/50 shadow-sm">
            ...
            <div className="relative p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">Sistema de Lembretes</h3>
                    <p className="text-gray-600 text-sm">Ative ou desative o envio automático de lembretes</p>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-bold text-gray-800">Horários de Envio</h3>
              <div className="flex-1 h-px bg-gradient-to-r from-gray-300 to-transparent"></div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Morning Reminder */}
              <div className="group relative overflow-hidden bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl border border-yellow-200/50 shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    <div className="flex-1">
                      <label className="flex items-start gap-3 cursor-pointer">
                        <input
                          ...
                          className="mt-1 w-5 h-5 text-yellow-600 border-yellow-300 rounded focus:ring-yellow-500 transition-all duration-200"
                          disabled={!canEdit}
                        />
                        <div>
                          <span className="text-sm font-bold text-gray-900 block">Lembrete Matinal</span>
                          <span className="text-xs text-gray-600">Enviado às 8h da manhã</span>
                        </div>
                      </label>
                    </div>
                  </div>
              ...
              {/* 2 Hours Before */}
              <div className="group relative overflow-hidden bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border border-blue-200/50 shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    <div className="flex-1">
                      <label className="flex items-start gap-3 cursor-pointer">
                        <input
                          ...
                          className="mt-1 w-5 h-5 text-blue-600 border-blue-300 rounded focus:ring-blue-500 transition-all duration-200"
                          disabled={!canEdit}
                        />
                        <div>
                          <span className="text-sm font-bold text-gray-900 block">2 Horas Antes</span>
                          <span className="text-xs text-gray-600">Lembrete com antecedência</span>
                        </div>
                      </label>
                    </div>
                  </div>
              ...
              {/* 1 Hour Before */}
              <div className="group relative overflow-hidden bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200/50 shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    <div className="flex-1">
                      <label className="flex items-start gap-3 cursor-pointer">
                        <input
                          ...
                          className="mt-1 w-5 h-5 text-purple-600 border-purple-300 rounded focus:ring-purple-500 transition-all duration-200"
                          disabled={!canEdit}
                        />
                        <div>
                          <span className="text-sm font-bold text-gray-900 block">1 Hora Antes</span>
                          <span className="text-xs text-gray-600">Lembrete de última hora</span>
                        </div>
                      </label>
                    </div>
                  </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800">Personalização da Mensagem</h3>
              <div className="flex-1 h-px bg-gradient-to-r from-gray-300 to-transparent"></div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50/50 rounded-2xl border border-gray-200/50 p-6">
              ...
              <textarea
                ...
                rows={8}
                className="w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white/80 backdrop-blur-sm transition-all duration-200 resize-none"
