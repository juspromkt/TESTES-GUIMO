        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Visualize e gerencie todos os seus compromissos</p>
            </div>
          </div>
          {canEdit && (
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-12 pr-10 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white transition-all duration-200"
            >
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-3">
                          ...
                          <div>
                            <p className="text-xs font-medium text-blue-600 uppercase tracking-wide">Data</p>
                        ...
                        <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-3">
                          ...
                          <div>
                            <p className="text-xs font-medium text-green-600 uppercase tracking-wide">Horário</p>
                            <p className="text-sm font-semibold text-gray-900">
                        ...
                        <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-3">
                          ...
                          <div>
                            <p className="text-xs font-medium text-purple-600 uppercase tracking-wide">Cliente</p>
