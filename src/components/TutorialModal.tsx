    ...
    <>
      {createPortal(
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center p-8 z-[10001] animate-fadeIn">
          <div
            className="bg-gradient-to-br from-white via-white to-purple-50/50 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-900 rounded-3xl shadow-2xl w-full max-w-[1400px] aspect-video overflow-hidden border border-purple-300/50 dark:border-purple-600/50 transition-theme relative"
          >
            {/* Decorative elements */}
            ...
            <div className="relative z-10 h-full flex items-stretch">
              ...
              <div className="flex-1 p-10 flex flex-col justify-center">
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    />
                    <h2 className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 bg-clip-text text-transparent leading-tight">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  {tutorials.map((tutorial, index) => (
                    <button
                      ...
                      className="group bg-white dark:bg-neutral-800 backdrop-blur-sm rounded-xl p-4 border border-gray-300 dark:border-neutral-600 hover:border-purple-400 dark:hover:border-purple-500 transition-all hover:shadow-lg text-left"
                    >
                      <div className="flex items-start gap-3">
                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${tutorial.color} flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 transition-transform`}>
              ...
              <div className="w-[440px] bg-gradient-to-br from-purple-50/80 to-blue-50/80 dark:from-neutral-800/80 dark:to-neutral-800/80 backdrop-blur-sm border-l border-gray-200 dark:border-neutral-700 p-10 flex flex-col justify-center">
                {/* Tips */}
                <div className="mb-8">
                ...
                <div className="space-y-3">
                  <button
                    onClick={onClose}
                    className="w-full px-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold text-base rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group"
                  >
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-white dark:bg-neutral-800 border-2 border-purple-600 dark:border-purple-500 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-neutral-700 font-semibold text-base rounded-xl transition-all flex items-center justify-center gap-3 group"
                  >
